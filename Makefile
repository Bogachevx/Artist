...
# Template: app
# Command: C:\Qt\5.11.0\mingw53_32\bin\qmake.exe -o Makefile FaceDraw.pro -spec win32-g++
#############################################################################
...
Makefile: FaceDraw.pro C:/Qt/5.11.0/mingw53_32/mkspecs/win32-g++/qmake.conf C:/Qt/5.11.0/mingw53_32/mkspecs/features/spec_pre.prf \
		...
		FaceDraw.pro \
		C:/Qt/5.11.0/mingw53_32/lib/qtmain.prl \
	...
	$(QMAKE) -o Makefile FaceDraw.pro -spec win32-g++
